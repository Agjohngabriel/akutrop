<?php include 'inc/header.php' ?>    
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('images/project5.jpg');">
        <div class="container">
      ...
      <div class="intro-section" style="background-image: url('images/project4.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
            ...
            <h3>Our Mission</h3>
            <p>It is our mission to help our clients
              harness the best value through communal
              efforts by providing quality products and
              excellent service using our pool of
              dedicated men and women of ability. This
              will enable us fulfill our customers’
              requirements effectively, ensure optimum
              value to our shareholders and remain a
              responsible corporate member of our
          ...
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
            ...
            <h3>Our Goal</h3>
            <p>It is our goal to be the finest, our
              unwavering focus is geared towards
              a
              total commitment in providing products
              and services of highest quality for full
              customer satisfaction.</p>
          </div>
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
            <span class="icon flaticon-library"></span>
            <h3>Value</h3>
            <p>To enable us effectively serve our clients,
              we are committed to enriching, establishing
              and maintaining the necessary systems and
              procedures designed to conform fully with
              applicable
              national
              and
              international
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-5 ml-auto">
              ...
              <p>AKUTROP, as an EPIC company with its affiliates and strategic
                partners are dedicated to engineering, procuring, installations,
                construction and contracting excellence in servicing the oil and gas
                industry.</p>
        ...
        <div class="projects-carousel-wrap">
          <div class="owl-carousel owl-slide-3">
              ...
              <div class="project-item-contents">
                <a href="#">
                  ...
                  <h2 class="project-item-title">
                    Joint Firing line – Semi Auto
                  </h2>
                </a>
              </div>
              <img src="images/project1.jpg" alt="Image" class="img-fluid">
            </div>
            <div class="project-item">
              <div class="project-item-contents">
                <a href="#">
                  <span class="project-item-category">Factory</span>
                  <h2 class="project-item-title">
                    Alakiri Gas Plant Construction 
                  </h2>
                </a>
              </div>
              <img src="images/project2.jpg" alt="Image" class="img-fluid">
            </div>
            <div class="project-item">
              <div class="project-item-contents">
                <a href="#">
            ...
            <div class="project-item">
              ...
              <img src="images/project4.jpg" alt="Image" class="img-fluid">
            </div>
